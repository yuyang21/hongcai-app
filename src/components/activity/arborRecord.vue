<template>
  <div class="Arbor_record" v-auto-height>
    <div class="recordBox">
      <div class="recordList clearfix">
        <span class="form_head fr">年化投资记录<span class="fr">(活动期间)</span></span>
        <img src="../../images/arbor-day/coin-icon.png" alt="" width="10%" class="fr">
        <!-- 年化投资记录 -->
...
<style scoped>
  .Arbor_record {
    background: url('../../images/arbor-day/record-bg.png') no-repeat 0 0;
